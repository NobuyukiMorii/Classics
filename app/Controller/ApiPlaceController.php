...
class ApiPlaceController extends AppController {
    ...
    public function index() {
        $PlaceAllList = $this->Place->find('all');
        $this->set(array(
            'PlaceAllList' => $PlaceAllList,
            '_serialize' => array('PlaceAllList'),
        ));
    }
    ...
    public function view($id) {
        $PlaceSingleData = $this->Place->findById($id);
        $this->set(array(
            'PlaceSingleData' => $PlaceSingleData,
            '_serialize' => array('PlaceSingleData')
        ));
    }
